...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="background-image: linear-gradient(rgba(255,255,255,0.5),rgba(255,255,255,0.5)), url('../../img/fondo-index-body.png'); height: 100vh; background-repeat: no-repeat">
        <div style="padding-top: 90px; margin-bottom: 20px">
            <h1 style="text-align: center; font-family: Abril Fatface; font-size: 34px; font-style: normal; font-variant: normal; font-weight: 700; line-height: 26.4px; color: forestgreen">Términos de Promociones y Premios
            </h1>
        </div>
