...
<head runat="server">
    ...
    <link href="css/estilos-login5.css?Fv2" rel="stylesheet" type='text/css'/>
...
<body>
    ...
    <div id="fondoFormularioLogin">
        <div class="login-card">
                ...
                <asp:Login ID="LoginUser" runat="server" EnableViewState="false" OnAuthenticate="LoginUser_Authenticate" Width="100%">
                    <LayoutTemplate>
                        ...
                        <div class="col-lg-12 logo-kapsul">
                            <img id="imgLogoParaLogin" width="250" class="logo" src="" alt="Logo" style="padding-top: -40px; padding-bottom: -40px; display:none;" />
                            <br />
                            ...
                            <div>
                                <p class="claseFuente1">Bienvenido a Mitosiz</p>
                            </div>
                            <br />
                        ...
                        <div class="group" id="campoUsuario" style="margin-top: 30px">
                            ...
                            <asp:TextBox ID="UserName" runat="server" placeholder="Ingrese usuario..." MaxLength="10"></asp:TextBox>
                        </div>
            ...
            <form id="sifre-hatirlat-form" class="col-lg-12" style="margin-bottom: auto; margin-top: auto;">
                ...
                <div class="col-lg-12 logo-kapsul">
                            <img id="imgLogoParaLogin" width="250" class="logo" src="" alt="Logo" style="padding-top: -40px; padding-bottom: -40px" />
                            <br />
                            <%--<img width="110" src="https://dqcgrsy5v35b9.cloudfront.net/cruiseplanner/assets/img/icons/login-w-icon.png" style="top: 20px; padding-bottom: 50px; padding-top: -30px" />--%>
                            <%--<img id="bienvenidosLogin" width="250" src="img/bienvenidos-login.png" style="top: 20px; padding-bottom: 50px" />--%>
                            <div>
                                <p class="claseFuente1"></p>
                            </div>
                            <br />
                            <h4 class="claseFuente2" id="ingreseDatos"></h4>
                            <br />
                ...
                <div class="col-lg-12 logo-kapsul">
                    <img width="110" class="logo" src="" alt="Logo" />
                </div>
    ...
    <script src="js/estilos-login3.js?Fv2"></script>
