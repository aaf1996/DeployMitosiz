...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content">
                ...
                <div class="box box-success">
                    ...
                    <div style="padding-left: 11px; margin-bottom: 30px" class="col-md-12">
                        <div class="col-md-6">
                            ...
                            <asp:Button runat="server" Text="C. Tiburon" CssClass="btn btn-twitter" Style="font-weight: bold; margin-right: 10px; margin-top:20px" ID="btnComTibu"/>
                            ...
                            <asp:Button runat="server" Text="C. Tiburon" CssClass="btn btn-twitter" Style="font-weight: bold; margin-right: 10px; margin-top:20px" ID="btnComTiburon1" Visible="false"/>
                            <asp:Button runat="server" Text="C. Tiburon E." CssClass="btn btn-twitter" Style="font-weight: bold; margin-right: 10px; margin-top:20px" ID="btnComTiburon2" Visible="false"/>
                        ...
                        <div class="col-md-2">
                            <button type="button" runat="server" class="btn btn-instagram" id="btnListaBonos">Listar Bonos</button>
                        </div>
                    </div>
                    <!-- Modal -->
        ...
        <script src="js/CalculaRangov6.js?V4" type="text/javascript"></script>
