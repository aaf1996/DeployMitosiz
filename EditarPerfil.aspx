...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link href="css/proyecto2/estilosCrearCuenta.css?v3" rel="stylesheet" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="container-fluid d-flex align-items-center">
                <div class="row">
                    <div class="col-lg-7 col-md-10">
                        <h1 class="display-2 text-white">Bienvenido <%=nombres %></h1>
                        ...
                        <div class="card-body">
                            <div class="tab-content p-3">
                                <div class="tab-pane active show" id="edit">
                                     <div class="form-group row" style="display:none;">
                                           <div class="col-lg-4">
                                            <div class="form-group focused">                                                              
                                                 <button type="button" class="btn btn-success col-sm-5" id="btnCambiarClave" onclick="open_cambiar_password();">Cambiar Clave &nbsp   <i class="glyphicon glyphicon-edit" onclick="open_cambiar_password();"></i></button>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-4">
                                            <div class="form-group focused">
                                                ...
                                                <label class="col-form-label form-control-label" style="color:red; display:none;">** Si desea modificar la dirección contactesé con atención al cliente</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-8">
                                            <div class="form-group focused">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-4">
                                            <label class="col-form-label form-control-label">País</label>
                                    ...
                                    <div class="form-group row text-center">
                                        <div class="col-lg-12">
                                            <asp:Button CssClass="btn-lg btn1 btn-success form-controlEPP anchoBotonGuardar" ID="btnSave" runat="server" Text="GUARDAR" />
                                        </div>
                                    </div>
    ...
    <script src="js/EditarPerfilNuevoV3.js?v4"></script>
    ...
    <script>
          ...
          window.onload = function () {
              document.getElementById("idEditarPerfil").style.color = 'white';
