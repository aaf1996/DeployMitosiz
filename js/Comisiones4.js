...
function RellenarDataGraficos() {
    ...
    $("#txtComiTotal").text(MONTOGENERAL.toFixed(2));
...
function RellenarDataPeriodo() {
    ...
    /*RELLENAR DATOS INDIVIDUALES DE LOS BONOS*/
    var PORX1 = 0, PORX2 = 0, PORX3 = 0, PORX4 = 0, PORX5 = 0, PORX6 = 0, PORX7 = 0,
        PORX8 = 0, PORX9 = 0, PORAFI1 = 0, PORAFI2 = 0, PORAFI3 = 0, PORAFI4 = 0, PORAFI5 = 0;
    PORX1 = (UNIX1 == 0) ? 0 : Math.round((UNIX1 / COMUNI) * 100);
    PORX2 = (UNIX2 == 0) ? 0 : Math.round((UNIX2 / COMUNI) * 100);
    PORX3 = (UNIX3 == 0) ? 0 : Math.round((UNIX3 / COMUNI) * 100);
    PORX4 = (UNIX4 == 0) ? 0 : Math.round((UNIX4 / COMUNI) * 100);
    PORX5 = (UNIX5 == 0) ? 0 : Math.round((UNIX5 / COMUNI) * 100);
    PORX6 = (UNIX6 == 0) ? 0 : Math.round((UNIX6 / COMUNI) * 100);
    PORX7 = (UNIX7 == 0) ? 0 : Math.round((UNIX7 / COMUNI) * 100);
    PORX8 = (UNIX8 == 0) ? 0 : Math.round((UNIX8 / COMUNI) * 100);
    PORX9 = (UNIX9 == 0) ? 0 : Math.round((UNIX9 / COMUNI) * 100);
