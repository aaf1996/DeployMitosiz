...
function datosDetalleCompra(obj3) {
    ...
    $("#cboEstadoEnvio").val(obj3[0].estadoEnvio);
}

function updateDataAjax() {

    var ticket, montoPagar, montoComision, puntosTotal, montoTotal, fechaCompra, cantidadProd, idop,
        idtipocompra, tipoCompra, tipoPagoDet, estado, despacho, estadoEnvio;
    ...
    estadoEnvio = $("#cboEstadoEnvio").val();
    ...
    var obj9 = JSON.stringify({
        ...
        idtipoCom1: idtipocompra, tipoCom1: tipoCompra, tipoPagoCom1: tipoPagoDet, estadoCom1: estado,
        despachoCom1: despacho, estadoEnvio: estadoEnvio
    });
