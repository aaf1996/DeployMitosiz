...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content-header">
        <h1 style="text-align: center">Reporte de Compras Canje</h1>
    </section>
    <section class="content">
            ...
            <div class="col-xs-12">
                <div class="box box-success">
                    <div class="box box-header">
                        <h3 class="box-title">Listado de Compras Canje</h3>
                    </div>
        ...
        <script src="js/CompraEfectivov4.js?v7" type="text/javascript"></script>
